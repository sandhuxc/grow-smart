        ...
        <div className="wrapper2">
          <div className="left-card2">
            ...
            <input required
              ...
              onChange={(e) => {const high = parseInt(e.target.value);
             if (high >= 0 && high <= 130) {
              setHeight(high);
            }
}}/>
            ...
            <input required
              ...
              onChange={(e) => {const weigh = parseInt(e.target.value);
             if (weigh >= 0 && weigh <= 26) {
              setWeight(weigh);
            }}} />
            <button onClick={calculateBmi}>Save</button>
          </div>
          <div
