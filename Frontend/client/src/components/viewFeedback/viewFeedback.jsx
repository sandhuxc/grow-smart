...
const getFeedBacks = async() =>{
  let result = await fetch(`http://localhost:8000/viewFeedBack/${nutID}`,{
    headers:{
    }
});
          ...
          <section className="mainnut">
            ...
            <section class="attendance">
              <div class="attendance-list">
                ...
                <div className="cards">
              {Feedback.length > 0 && Feedback.map((fd) => (
                <div className="card">
                  <div className="content">
                    <div className="details">
                    <div className="feedback">{fd.parentName} </div>
                      <div className="feedback">{fd.feedback} </div>
                      <div className="Rating">{fd.stars} Rating</div>
                    </div>
